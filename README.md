...
![print da primeira análise - gold_mean_total.pgn](darch-tech-eval-main/img/gold_mean_total.png)
* **Pergunta 2:** Média de passageiros (`passenger_count`) por cada hora do dia no mês de maio.
![print da segunda análise - gold_mean_total.pgn](darch-tech-eval-main/img/gold_mean_total.png)
